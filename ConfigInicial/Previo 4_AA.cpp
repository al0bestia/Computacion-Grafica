...
// permiten manipular la vista directamente para poder manipular el entorno sin tener que estar compilando
// y cerrando el programa nuevamente 
float movX=0.0f;
float movY=0.0f;
float movZ=-5.0f;
float rot = 0.0f;
int main() {
	...
	float vertices[] = {
		// x,   y ,    z     colores: ROJO, VERDE, AZUL
		//6 vertices son necesarios para cada cara
		//cada cara tiene 2 triangulos
 ...
 // maneja el teclado para interactuar en tiempo real
 void Inputs(GLFWwindow *window) {
